...
typedef unsigned char U8;							//定义单字节无符号整数，这样就不纠结char这个类型了，现在是单字节整数
...
extern char strDevID[128];			//设备号，字符串形式，从1开始
extern char strLayer[128];				//层次名
extern char strEntity[128];				//实体号，字符串形式，从0开始，可以通过atoi函数变成整数在程序中使用
